...
<body>
	...
	<?php
     ...
     <br></br>
		...
		<form action="acciones/ingresoSitema.php" class="form-signin"
			method="POST" enctype="multipart/form-data" id="frmLogin">
			
				<center>
					<img src="img/logos/logoPrincipal.svg" width="100%" height="100%" alt="logo" />
				</center>
	...
	<!-- /container -->
	<footer><center><p style="color: #575859;">Desarrollado por USAID</p></center><center><p style="color: #575859;">v1.2.1</p></center></footer> 
</body>
</html>